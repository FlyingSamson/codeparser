...
elseif (CMAKE_HOST_APPLE)
	...
	set(MATHLINK_LIB_DIR_DEFAULT ${MATHEMATICA_INSTALL_DIR}/SystemFiles/Links/MathLink/DeveloperKit/MacOSX-x86-64/CompilerAdditions)
        ...
        if( ${ARCHITECTURE} STREQUAL "x86_64" )
                set( LINUX_DIR "Linux-x86-64" )
        elseif( ${ARCHITECTURE} STREQUAL "armv7l" )
                set( LINUX_DIR "Linux-ARM" )
        endif()
	set(WOLFRAMKERNEL_DEFAULT ${MATHEMATICA_INSTALL_DIR}/Executables/WolframKernel)
	set(WOLFRAMLIBRARY_INCLUDE_DIR_DEFAULT ${MATHEMATICA_INSTALL_DIR}/SystemFiles/IncludeFiles/C)
	set(MATHLINK_INCLUDE_DIR_DEFAULT ${MATHEMATICA_INSTALL_DIR}/SystemFiles/Links/MathLink/DeveloperKit/${LINUX_DIR}/CompilerAdditions)
	set(MATHLINK_LIB_DIR_DEFAULT ${MATHEMATICA_INSTALL_DIR}/SystemFiles/Links/MathLink/DeveloperKit/${LINUX_DIR}/CompilerAdditions)
endif()
